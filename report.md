...
Die Fischer werden als Agenten modelliert, die durch ihre Position, Strategie, ihren aktuellen und kumulativen Fang sowie die Sanktionskosten charakterisiert sind. Die Fischer bewegen sich in jedem Zeitschritt auf dem See-Gitter mit einer Wahrscheinlichkeit von 80 % auf den Patch in der Moore-Nachbarschaft, der die höchste Biomasse aufweist. Mit einer Wahrscheinlichkeit von 20% bewegen sie sich auf einen zufälligen benachbarten Patch. Die Fischer haben vier mögliche Strategien: Egoist, Kooperator, Sanktionierer und Imitator.\
<br>
...
In Szenario 3 stabilisiert sich das System nach einer anfänglichen Einschwingungsphase. Zwischen Szenario 4 und Szenario 3 sind keine relevanten Unterschiede festzustellen, wie in der Diskussion näher ausgeführt. Das fünfte Szenario zeigt einen Gleichgewichtszustand, der nur durch lokale Überfischung oder starkes Wachstum aufgrund einer lokal geringen Fischer-Dichte leicht oszilliert. Szenario 6, das die soziale Umverteilung inkludiert, zeigt ein annähernd ähnliches Ergebnis in der Biomasse. Von der Umverteilung profitieren vor allem die Sanktionierer, da sie einen Anteil der eingezogenen Sanktionskosten behalten. Beim Fang der Kooperatoren ist hingegen trotz der Rückverteilung auf nachhaltige Fischer kein wesentlicher Vorteil gegenüber Szenario 5 ohne Umverteilung zu erkennen.
...
Szenario 1 zeigt anhand der exponentiell abfallenden Biomasse deutlich, dass Hardins Theorie des Systemkollapses bei einer frei verfügbaren Ressource unter der Annahme eines egoistischen Eigenverhaltens der Akteure durchaus zutrifft. Ein Einbezug von Kooperatoren sorgt lediglich für ein zeitlich verzögertes Aussterben der Biomasse - logisch nachvollziehbar, da Kooperatoren ebenfalls egoistisch handeln, sofern sich zu viele Egoisten in ihrer Sichtweite befinden. Die bereits zuvor beschriebene eintretende Stabilisierung des Systems in Szenario 3 wird durch die Einführung des Sanktionierers als institutionelle Kontrollmaßnahme möglich. Die zuvor beschriebene Ähnlichkeit zwischen Szenario 4 und 3 basiert darauf, dass die hinzugefügten Imitatoren (vor allem bei einer verhältnismäßig hohen Anzahl an Egoisten) mit einer hohen Wahrscheinlichkeit einen Egoisten in Sichtweite haben, dieser einen hohen Fang hat, und dementsprechend ebenfalls egoistisch agieren. Die Szenarien 5 und 6 zeigen schließlich eine stabile Biomasse bei ca. 40% Bestand. Dies bestätigt teilweise die These von Ostrom der Stabilität durch Kooperation, wenn auch im Fall dieses Modells vor allem erst durch institutionelle Kontrolle.
<br>
Aus Szenarien 5 und 6 geht weiters hervor, dass Sanktionierer am meisten von der Umverteilung der Sanktionskosten profitieren, da sie einen Anteil des eingezogenen Fanges behalten. Die Kooperatoren profitieren hingegen nicht wesentlich von der Umverteilung, was auf den Umstand zurückzuführen sein könnte, dass Kooperatoren bei mehrheitlich egoistischer Nachbarschaft ebenfalls egoistisch fischen und somit nicht von der Verteilung der Sanktioniskosten profitieren. Ebenso könnte es sein, dass die umverteilte Fangmenge durch die Verteilung auf eine größere Anzahl von Fischern nicht ausreichend ist, um einen relevanten Unterschied zu machen.
<br>
...
<br>
Eine starke negative Rückkopplung ist hingegen die Funktion des Sanktionierers. Dieser hat zur Folge, dass Imitatoren sich unter Umständen dagegen entscheiden, ihren benachbarten Egoisten zu imitieren, wodurch es in Summe wie anhand von Szenario 5 und 6 ersichtlich, zu mehr nachhaltiger Fischerei kommt.

Limitationen des Modells betreffen vor allem dieses Kipppunkt-Verhalten des Modells. In weiterer Bearbeitung des Projektes wären Maßnahmen sinnvoll, sei es durch stärkeres Bestrafen der Egoisten, um dessen Attraktivität auf den Imitator zu reduzieren oder eventuell auch durch völliges Weglassen des Imitators.
<br>
Der nachhaltige Fang der Kooperatoren und Sanktionierer stellt eine weitere Limitation dar. Nachhaltiger Fang ist in diesem Modell dynamisch als Biomasse definiert, die im nächsten Schritt nachwachsen kann, multipliziert mit einem Faktor. Der nachhaltige Fang ist demnach mit der logistischen Wachstumsfunktion gekoppelt, die nahe der Kapazitätsgrenze ein stark abflachendes Wachstum und damit einen sehr geringen nachhaltigen Fang ermöglicht. Daraus ergibt sich, dass nachhaltiger Fang bei hohem Biomassebestand nur einen geringen Ertrag bringt, was in der Realität eher unwahrscheinlich ist. Eine mögliche Alternative dazu wäre, einen festen Anteil der Biomasse zu entnehmen, sodass bei höherer Biomasse ein größerer Ertrag möglich ist.
<br>
Das Verhalten der Imitatoren ist in diesem Modell zudem sehr simpel gehalten, da sie lediglich die Fangstrategie des erfolgreichsten Nachbarn übernehmen, sofern dieser erfolgreicher ist als der Imitator selbst. Das Imitieren von Kooperatoren und Sanktionierern ist hier demnach nur durch nachhaltiges Fangen implementiert, der konditionale nachbarschaftsabhängige Strategiewechsel der Kooperatoren sowie das Durchführen von Sanktionen werden beim Imitieren nicht berücksichtigt. Es kann jedoch davon ausgegangen werden, dass dies die Ergebnisse nicht wesentlich beeinflusst, da Egoisten in allen Szenarien die profitabelste Strategie darstellen und somit alle Imitatoren mit hoher Wahrscheinlichkeit dennoch Egoisten imitieren würden.
...
- Konditionaler Kooperator: Berechnet eine nachhaltige Fangmenge basierend auf dem beobachteten Gesamtbestand. Kooperation ist an die wahrgenommene Kooperationsbereitschaft der Nachbarn geknüpft
