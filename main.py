...
SANCTION_THRESHOLD = 1.2 # Threshold for non-sustainable catch above which they are sanctioned by sanctioners
SUSTAINABLE_CATCH_MULTIPLIER = 5 # Multiplier used to calculate the sustainable catch for cooperators and sanctioners
